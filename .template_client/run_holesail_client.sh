...
read -p "What port do you want to use to find your service locally?: " holesail_port
...
echo "HOLESAIL_PORT=${holesail_port}  # The port you want to use to find your service locally" >> .env
